		...
		this.handlers = {
			window: {
				mousemove: function(e){
					config.position.x = e.clientX - canvas.getBoundingClientRect().left;
					config.position.y = e.clientY - canvas.getBoundingClientRect().top;
				},
				resize: function () {
...
$('#constellation-canvas').constellation({
    star: {
        width: 3
    },
    line: {
